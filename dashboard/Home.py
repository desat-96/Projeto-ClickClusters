...
if df_final_app is not None:
    ...
    with st.expander("Clique aqui para ver a descrição detalhada de cada segmento"):
        st.markdown("""
        * **<span style='color:#E86800; font-weight:bold;'>Super Compradores:</span>** A elite dos clientes. Representam o menor grupo (1.23%), mas com o maior poder de compra e a maior frequência. São os clientes mais valiosos e leais da plataforma. 
        
        * **<span style='color:#9400F7; font-weight:bold;'>Viajantes Inativos:</span>** Representam 25.74% da base, mas são clientes que não realizam uma compra há quase 6 anos em média. Para fins práticos, são considerados clientes perdidos, e o foco para eles seria em campanhas de "win-back" de alto impacto.
        
        * **<span style='color:#EBBC00; font-weight:bold;'>Viajantes Ocasionais:</span>** O maior segmento da base de clientes. São usuários que compram de forma esporádica (frequência de 2.20) e não interagem com a plataforma há um tempo considerável (recência de 556 dias). O principal objetivo para este grupo é reengajamento.
        
        * **<span style='color:#D4A3FF; font-weight:bold;'>Viajantes Promissores:</span>** Um grupo valioso (19.46%) com forte potencial de crescimento. Compram com boa frequência e possuem um gasto significativo. São a base para futuras campanhas de fidelização com o objetivo de elevá-los ao status de Viajantes Frequentes.
